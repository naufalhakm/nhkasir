...
Route::group(['middleware' => ['auth', 'checkRole:admin,manager,staf']], function(){
	...
	Route::get('/supplyreturn', 'SupplyManageController@viewSupplyReturn');
	Route::get('/supply/delete', 'SupplyManageController@viewDeleteSupply');
	...
	Route::post('/supply/return', 'SupplyManageController@returnSupply');
