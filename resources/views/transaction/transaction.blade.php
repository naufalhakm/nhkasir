                                    ...
                                    @foreach ($products as $product)
                                        ...
                                        @else
                                            <li
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="ammount-box bg-green mr-1"><i
                                                            class="mdi mdi-coin"></i></span>
                                                    <p class="m-0">Rp.
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-4">
                                <table class="table-payment-2">
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <span class="subtotal-td">PPN</span>
                                        </td>
                                        <td class="text-right d-flex justify-content-end align-items-center pt-2">
                                            <span class=" mr-1" name="ppn" value="5">5</span>
                                            <span>%</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-right d-flex justify-content-end align-items-center pt-2">
                                            <input type="number" class="form-control diskon-input mr-2" min="0" max="100"
                                                name="diskon" value="0" hidden="">
        ...
        $(document).on('click', '.btn-pilih', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    var check = $('.kode-barang-td:contains(' + response.product.kode_barang + ')')
                        .length;
                    if (check == 0) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.check == 'tersedia') {
                        if (check == 0) {
                            tambahData(response.product.kode_barang, response.product.nama_barang,
                                response.product.harga, response.product.stok, response.status);
                            $('.close-btn').click();
                        } else {
                            swal(
                                "",
