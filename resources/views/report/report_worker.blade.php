                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <span class="btn staf-span">{{ $user->role }}</span>
                                                @endif
                                            </td>
                                            @php
                                                $pasok = \App\Supply::where('id_pemasok', $user->id)->count();
                                            @endphp
                                            <td class="pl-4"><span class="ammount-box bg-secondary"><i
                                                        class="mdi mdi-import"></i></span>{{ $pasok }} X</td>
                                            @php
                                            ...
                                            @endphp
                                            <td class="pl-4"><span class="ammount-box bg-secondary"><i
                                                        class="mdi mdi-swap-horizontal"></i></span>{{ $transaksi->count() }}
                                                X</td>
                                            <td>
                                                <a href="{{ url('/report/workers/detail/' . $user->id) }}"
                                                    class="btn view-btn"><i class="mdi mdi-eye"></i> Lihat</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
