                        ...
                        <div class="row">
                            <div class="col-12 img-import-area">
                                @if ($supply_system->status == true)
                                    <img src="{{ asset('images/instructions/ImportProduct.jpg') }}"
                                        class="img-import">
                                @else
                                    <img src="{{ asset('images/instructions/ImportProduct2.jpg') }}"
                                        class="img-import">
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="card card-noborder b-radius">
                        <div class="card-body">
                            ...
                            <div class="d-flex py-2 border-bottom">
                                <div class="wrapper">
                                    <p class="font-weight-semibold text-gray mb-0">1. Siapkan data dengan format Excel
                                        (.xls atau .xlsx)</p>
