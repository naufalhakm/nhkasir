                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 mt-3">
                                            ...
                                            <div class="col-4 left-min d-flex">
                                                <div class="btn-group">
                                                    <button class="btn btn-search" data-toggle="modal"
                                                        data-target="#tableModal" type="button">
                                                        <i class="mdi mdi-magnify"></i>
                                                    </button>
                                                    <button class="btn btn-scan" data-toggle="modal"
                                                        data-target="#scanModal" type="button">
                                        ...
                                        <div class="form-group row top-min">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control number-input input-notzero"
                                                    name="return" placeholder="Masukkan Jumlah">
                                            </div>
                                        ...
                                        <div class="form-group row top-min">
                                            ...
                                            <div class="col-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control number-input input-notzero"
                                                        name="harga_beli" placeholder="Masukkan Harga Satuan">
                                                </div>
                                            </div>
                                    ...
                                    <form action="{{ url('/supply/import') }}" method="post" name="import_form"
                                        ...
                                        <button class="btn btn-block mt-3 btn-upload" type="submit" hidden="">Import
                                            Data</button>
                                        <div class="row mt-4">
                                            <div class="col-12">
                                                ...
                                                <div class="d-flex py-2 border-bottom">
                                                    <div class="wrapper">
                                                        <p class="font-weight-semibold text-gray mb-0">1. Siapkan data
                                                            dengan format Excel (.xls atau .xlsx)</p>
                                                        <small class="text-muted">
                                                            <a href="" role="button" class="link-how"
                                                                data-toggle="modal"
                                                ...
                                                <div class="d-flex py-2 border-bottom">
                                                    <div class="wrapper">
                                                        <p class="font-weight-semibold text-gray mb-0">2. Jika sudah sesuai
                                                            pilih file</p>
                                                    </div>
                                                </div>
                                                <div class="d-flex py-2">
                                                    <div class="wrapper">
                                                        <p class="font-weight-semibold text-gray mb-0">3. Klik simpan, maka
                                                            data otomatis tersimpan</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.btn-tambah', function(e) {
            ...
            var jumlah = $('input[name=return]').val();
            var harga_beli = $('input[name=harga_beli]').val();
            var total = parseInt(
                jumlah) * parseInt(harga_beli);
            if (validator.valid() == true) {
                $.ajax({
                    url: "{{ url('/supply/data') }}/" + kode_barang,
                    method: "GET",
                    success: function(response) {
                        var check = $('.kd-barang-field:contains(' + response.product.kode_barang + ')')
                            .length;
                        if (check == 0) {
                            $('input[name=kode_barang]').val('');
                            $('input[name=return]').val('');
                            $('input[name=harga_beli]').val('');
                            $('tbody').append('<tr><td><span class="kd-barang-field">' + response
                                .product.kode_barang + '</span><span class="nama-barang-field">' +
                                response.product.nama_barang + '</span></td><td>' +
                                jumlah +
                                '</td><td>Rp. ' + parseInt(harga_beli).toLocaleString() +
                                '</td><td class="text-success">Rp. ' + parseInt(total)
                                .toLocaleString() +
                                '</td><td><button type="button" class="btn btn-icons btn-rounded btn-secondary ml-1 btn-delete"><i class="mdi mdi-close"></i></button><div class="form-group" hidden=""><input type="text" class="form-control" name="kode_barang_supply[]" value="' +
                                response.product.kode_barang +
                                '"><input type="text" class="form-control" name="jumlah_supply[]" value="' +
                                jumlah +
                                '"><input type="text" class="form-control" name="harga_beli_supply[]" value="' +
                                harga_beli + '"></div></td></tr>');
