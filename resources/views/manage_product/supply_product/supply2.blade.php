    ...
    <div class="row page-title-header">
        <div class="col-12">
            <div class="page-header d-flex justify-content-between align-items-center">
                <h4 class="page-title">Riwayat Pengembalian Pasok</h4>
                <div class="d-flex justify-content-start">
                    ...
                    <a href="{{ url('/supply/delete') }}" class="btn btn-icons btn-inverse-primary btn-new ml-2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-3 font-weight-bold"><span
                                                            class="ammount-box bg-secondary"><i
                                                                class="mdi mdi-cube-outline"></i></span>{{ $supply->return }}
                                                    </td>
                                                    ...
                                                    <td class="total-field font-weight-bold text-danger"></td>
