...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('icons/nh.png') }}" />
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
                <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}">
                    <img src="{{ asset('icons/ksr.png') }}" alt="logo" /> </a>
                <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}">
                    <img src="{{ asset('icons/nh.png') }}" alt="logo" /> </a>
            </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="kelola_barang">
                                    <ul class="nav flex-column sub-menu">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('/supplyreturn') }}">Return Pasok
                                                Barang</a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="container-fluid clearfix">
                        <div class="justify-content-center d-flex">
                            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright
                                &copy;
                                2021 J3D219167 | Naufal Hakim</span>
                        </div>
                    </div>
                </footer>
            </div>
